...
class MyPlannings extends StatefulWidget {
  ...
  @override
  State<MyPlannings> createState() => _UserPlanningsState();
}

class _UserPlanningsState extends State<MyPlannings> {
  ...
  getPlannings() async {
    ...
    http.Response response = await CallApi().getData('myplans/${userData['id']}');
