...
class AssignedInHoldActivities extends StatefulWidget {
  final int status;
  const AssignedInHoldActivities({Key? key, required this.status}) : super(key: key);

  @override
  State<AssignedInHoldActivities> createState() => _UnAssignedActivitiesState();
}

class _UnAssignedActivitiesState extends State<AssignedInHoldActivities> {
  @override
                    ...
                    itemBuilder: (context, index) {
                      return Center(
                        ...
                        children: [
                          ...
                          Text(
                            "There is no activity in hold yet ",
