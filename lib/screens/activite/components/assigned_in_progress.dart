...
class AssignedInProgress extends StatefulWidget {
  final int status;
  const AssignedInProgress({Key? key, required this.status}) : super(key: key);

  @override
  State<AssignedInProgress> createState() => _AssignedInProgressState();
}

class _AssignedInProgressState extends State<AssignedInProgress> {
  @override
                    ...
                    itemBuilder: (context, index) {
                      return Center(
                        ...
                        children: [
                          ...
                          Text(
                            "There is no activity in progress yet ",
