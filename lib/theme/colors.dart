...
class LightColors {
  ...
  static const Color kPrimaryColor = Color(0XFF6A62B7);
  static const Color kDarkBlue = Color(0xFF0D253F);
  static Color textOnboarding = Color(0xFFE3E7E4);
  static Color blueCustomColor = Color(0xFF838EDC);
  static Color onBoardingColor = Color(0xFFd7dbe5);
  static Color bgColor = Color(0xffebecf1);
}
